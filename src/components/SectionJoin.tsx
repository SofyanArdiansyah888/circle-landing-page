...
const SectionJoin = () => {
    return <section className={"bg-background-join relative section-padding bg-black text-white py-16 lg:py-24"}>
        ...
        <div className={"rounded-xl border-[2px] border-gradient max-w-3xl mx-auto p-8"}>
