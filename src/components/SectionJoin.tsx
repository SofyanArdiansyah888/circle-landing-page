...
const SectionJoin = () => {
    return <section className={"bg-background-join relative section-padding bg-black text-white py-16 lg:py-16"}>
        ...
        <div className={"rounded-xl border-[2px] border-gradient max-w-4xl mx-auto px-10 py-6"}>
            ...
            <Button className={"mt-10 items-center text-lg text-center w-[180px] flex gap-2"}>
                Join Community
                <RightArrow/>
            </Button>
        </div>
